...
public class MovieController {
        ...
        public ResponseEntity<ApiResponse<MovieResponse>> getById(
                        @Parameter(description = "ID của phim", required = true) @PathVariable Integer id) {
        ...
        public ResponseEntity<ApiResponse<MovieResponse>> getBySlug(
                        @Parameter(description = "Slug của phim", required = true, example = "avengers-endgame") @PathVariable String slug) {
        ...
        public ResponseEntity<ApiResponse<MovieResponse>> update(
                ...
                return ResponseEntity
                                .ok(ApiResponse.success("Cập nhật phim thành công", movieService.update(id, request)));
        }
        ...
        public ResponseEntity<ApiResponse<PageResponse<MovieResponse>>> search(
                        @Parameter(description = "Tiêu đề phim (tìm kiếm gần đúng)") @RequestParam(required = false) String title,
                        @Parameter(description = "Năm phát hành") @RequestParam(required = false) Integer year,
                        @Parameter(description = "Tên đạo diễn (tìm kiếm gần đúng)") @RequestParam(required = false) String director,
                        @ModelAttribute PageRequest pageRequest) {
                return ResponseEntity.ok(ApiResponse.success(
                                movieService.search(title, year, director, pageRequest.getPage(),
                                                pageRequest.getSize())));
        }
        ...
        public ResponseEntity<ApiResponse<PageResponse<MovieResponse>>> getByGenre(
                        @Parameter(description = "ID thể loại", required = true) @PathVariable Integer genreId,
                        @ModelAttribute PageRequest pageRequest) {
                return ResponseEntity.ok(ApiResponse.success(
        ...
        public ResponseEntity<ApiResponse<PageResponse<MovieResponse>>> getByActor(
                        @Parameter(description = "ID diễn viên", required = true) @PathVariable Integer actorId,
                        @ModelAttribute PageRequest pageRequest) {
                return ResponseEntity.ok(ApiResponse.success(
        ...
        public ResponseEntity<ApiResponse<PageResponse<MovieResponse>>> getByCountry(
                        @Parameter(description = "ID quốc gia", required = true) @PathVariable Integer countryId,
                        @ModelAttribute PageRequest pageRequest) {
                return ResponseEntity.ok(ApiResponse.success(
        ...
        @Operation(summary = "Lấy phim theo danh mục", description = "Lấy danh sách phim theo danh mục (Phim lẻ, Phim bộ, Anime...)")
        public ResponseEntity<ApiResponse<PageResponse<MovieResponse>>> getByCategory(
                        @Parameter(description = "ID danh mục", required = true) @PathVariable Integer categoryId,
                        @ModelAttribute PageRequest pageRequest) {
                return ResponseEntity.ok(ApiResponse.success(
                                movieService.getByCategory(categoryId, pageRequest.getPage(), pageRequest.getSize())));
        }
}
